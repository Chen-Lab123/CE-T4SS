...
=head1 Description
		draw linear schema of alignment between two genomes (both complete and draft sequence are accepted)

=head1 Usage
		perl draw_genome_aligment_circle.pl [options]
...
my $y0=200;
my $PI=3.1415;
my %color=("+"=>"#CC3366","-"=>"#3366FF"); #������ȶԵ���ɫ
my %cds_color=("+"=>"red","-"=>"green"); #������������ɫ
...
if ($sca_file) {
	...
	#####################################
	#����ÿ��scaffold��ʼ��ƫ������Ϊ����ǰ������scaffold�ܳ��ȼ���gap�ĺͣ�����%sca_shift
	#####################################
	foreach (keys %sca) {
		$sca_shift{$_}=0;
